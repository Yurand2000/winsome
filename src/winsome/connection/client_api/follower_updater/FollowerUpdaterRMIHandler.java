...
public class FollowerUpdaterRMIHandler
{
	private final FollowerUpdaterRegistrator registrator;
	private FollowerUpdaterImpl updater;
	private FollowerUpdater stub;
	
	public FollowerUpdaterRMIHandler(String hostname, String user, Set<String> followers) throws IOException, NotBoundException
	{
