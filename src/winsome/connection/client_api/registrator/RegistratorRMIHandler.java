...
public class RegistratorRMIHandler
{
	...
	public static void register(String hostname, Integer port, String username, String password, String[] tags)
	{
		try 
		{
			RegistratorRMIHandler.tryRegister(hostname, port, username, password, tags);		
		}
	...
	private static void tryRegister(String hostname, Integer port, String username, String password, String[] tags) throws IOException, NotBoundException
	{
		Registrator registrator = RMIObjectLookup.getStub(hostname, port, Registrator.class, RegistratorRMI.getRegistratorName());
